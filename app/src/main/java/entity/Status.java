...
public class Status extends BaseEntity implements Serializable{
    ...
    private String in_replr_to_user_id;
    ...
    public String getIn_replr_to_user_id() {
        return in_replr_to_user_id;
    }

    public void setIn_replr_to_user_id(String in_replr_to_user_id) {
        this.in_replr_to_user_id = in_replr_to_user_id;
    }
    ...
    public String toString() {
        return "Status{" +
                ...
                ", in_replr_to_user_id='" + in_replr_to_user_id + '\'' +
